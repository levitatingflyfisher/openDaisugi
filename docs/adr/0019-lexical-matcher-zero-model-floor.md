...
1. **A signed-feature-hashing embedder, pure stdlib + numpy.** Tokenize
   ...
   Measured 2026-09-07 on the real journal (`~/.opendaisugi/journal/index.db`,
   740 rows, 324 usable non-placeholder tasks, 258 distinct), 20,000 random
   distinct-task pairs, plus a 20-pair hand-labeled paraphrase set. FPR target
