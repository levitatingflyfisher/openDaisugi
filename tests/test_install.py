...
def test_install_isolates_per_runtime_apply_failures(tmp_path):
    ...
    class Boom:
        ...
        # *args/**kwargs: the Runtime protocol widened (layers/enforce/base_url,
        # ADR-0013) — this fake only cares about being called, not the new args.
        def plan(self, h, *args, **kwargs):
            return []

        def apply(self, h, *args, **kwargs):
