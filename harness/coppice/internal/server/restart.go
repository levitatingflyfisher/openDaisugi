...
// closePane also refreshes a LivePane's cached Info and is the only path to
// Tree.ClosePane everywhere else in this package, but Restore runs before
// Serve, before any of these records has a LivePane yet, so that refresh
// would have nothing to update. This is the one place in the package that
// calls Tree.ClosePane directly, confined to this file.
