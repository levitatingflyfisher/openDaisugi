...
// narrower than it looks: state.Merge's own rule 5 (and, for THIS fixture,
...
// GateQuiet window (Merge rule 5) - either way scanOnce must skip, which is
...
// that scanOnce paused during the first two seconds: state.Merge's rule 5 is
