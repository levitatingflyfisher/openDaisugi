...
See **[the North Star](docs/north-star.md)** for the far-horizon dreams these problems
serve — the safe, fast, accountable pilot; the household of models; self-healing software
— read as one architecture at three scales, and where each one stresses the base hardest.
