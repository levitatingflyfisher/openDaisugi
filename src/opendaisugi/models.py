...
SHELL_INTERPRETERS: frozenset[str] = frozenset(
    {
        ...
        # ADR-0014 transparent wrappers: run CMD with an adjusted execution
        # context; the wrapped command is extracted and recursively verified.
        "timeout",
        "nice",
        "nohup",
        "time",
        ...
        "setsid",
        "ionice",
        # ADR-0014 opaque wrappers: privilege changes / re-execution loops —
        # not worth a subtle transparent parse; strict policy rejects them.
        "sudo",
        "doas",
        "watch",
    }
